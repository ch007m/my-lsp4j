...
public class ProxyLSPIntegrationTest {
    ...
    void setUp() throws Exception {
        ...
        snowdropLS = LSUtils.launchServer();
        
        // Initialize the language server using utility class
        LSUtils.initializeLanguageServer(snowdropLS.getServer(), tempDir);
    }
    ...
    void testAnnotationSearchFindsCorrectAnnotations() throws Exception {
        ...
        CompletableFuture<Object> commandResult = snowdropLS.getServer().getWorkspaceService()
    ...
    void testServerCapabilities() throws Exception {
        ...
        CompletableFuture<InitializeResult> initResult = snowdropLS.getServer().initialize(initParams);
    ...
    void testServerShutdown() throws Exception {
        ...
        CompletableFuture<Object> shutdownResult = snowdropLS.getServer().shutdown();
